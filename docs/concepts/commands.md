...
`commands.set` / `world.set` is mandatory for mutation — direct field writes bypass jecs hooks and break change detection. See [Change detection](/concepts/change-detection.md#mutation-must-go-through-commandsset--worldset).
