...
The unmodified source used by native gates is checked into `vendor/scribe` with
a SHA-256 manifest; production continues to resolve the Wally-installed peer.
