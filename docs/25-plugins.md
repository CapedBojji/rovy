...
- [Networking](23-networking.md) — production plugin using this pattern
- [Runtime lifecycle](20-runtime-lifecycle.md) — full `app.start()` sequence
- [Packages](21-packages.md) — how to ship a plugin as a separate roblox-ts package
