...
> **Compile-time.** `@observer` is processed by the transformer. Observers react to explicitly triggered or sent events — not to component lifecycle changes. For lifecycle reactions (enter, exit, change), use [Monitors](18-monitors.md).
