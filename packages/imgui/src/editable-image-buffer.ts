...
function assertImageSize(size: Vector2): void {
	...
	assert(
		...
		"[rovy-imgui] EditableImageBuffer size must be positive integer pixels",
	);
	assert(width <= 1024 && height <= 1024, "[rovy-imgui] EditableImageBuffer size cannot exceed 1024x1024");
}
